...
{
    public enum LengthOptions { MachineGun, FootLong };
    ...
    public class SandwichOrder
    {
        ...
        public static IForm<SandwichOrder> BuildForm()
        {
            ...
            {
                await context.PostAsync("This is the xxx of the form, you would give a final confirmation, and then start the ordering process as needed.");
            };
